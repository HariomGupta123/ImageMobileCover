...
const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate }: { shippingAddress: ShippingAddress, orderId: string, orderDate: string }) =>{
    const baseUrl = process.env.NODE_ENV === "development" ? "http://http://localhost:3000/" : "https://image-mobile-cover-p244.vercel.app/"
    return (
        <Html>
            <Head />
            <Preview>Your order summery and estimated delivery date </Preview>
            <Body style={main}>
