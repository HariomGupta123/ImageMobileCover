        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className=" text-lg leading-8">
                <p>
                  ...
                  , on the case I had before ,the image started fading into yellow-ish color after a couple weeks .LOve its "
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className=" text-lg leading-8">
                <p>
                  "I usaully use my phone together with my keys in my pocket and that led to some pretty heavy scrachmarks on all of my last phone cases .this one ,besides a barely noticeable scratch on corner,"
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bond text-5xl md:text-6xl text-gray-900">
          ...
          <div className="mx-outo max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              <Image src="/arrow.png" alt="arrow" width={100} height={100} className="absolute top-[25rem] md:top-1/2 -translate-y-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90 md:rotate-0" />
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
              ...
              <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5"/>
              Scatch- and fingerprint resistant coating
            </li>
              <li className="w-fit">
              <Check className="h-5 w-5 text-green-600 inline mr-1.5"/>
